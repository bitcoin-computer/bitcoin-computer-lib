...
if (chain == 'LTC'):
   subprocess.run(
       ['sh', '-c', 'RPC_HOST={rpcHost} RPC_PORT={port} RPC_PROTOCOL=http  RPC_USER={rpcUser} RPC_PASSWORD={rpcPass} CHAIN={chain} NETWORK={network} BCN_URL={nodeUrl} MWEB_HEIGHT=432 yarn start-setup'.format(
