...
cp -r ./.husky ../bitcoin-computer-lib/
cp -r ./.github ../bitcoin-computer-lib/
cp -r ./scripts ../bitcoin-computer-lib/
cp ./.mocharc-async.json ../bitcoin-computer-lib/
cp ./.mocharc-single.json ../bitcoin-computer-lib/
cp ./.mocharc.json ../bitcoin-computer-lib/
