// Type definitions for bitcoin-computer-bitcore

// TypeScript Version: 2.2

// <reference types="node" />

declare module 'bitcoin-computer-bitcore' {
    ...
    export namespace Transaction {
      ...
      export namespace Input {
        class MultiSigScriptHash {
          constructor(input: object, pubkeys: string[], threshold: number, signatures: Array<any> | null, redeemScript: Script);
        }
      }
